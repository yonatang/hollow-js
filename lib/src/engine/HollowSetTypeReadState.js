  ...
  readSnapshot(input, numShards = 1) {
    ...
    for (let shardIndex = 0; shardIndex < numShards; shardIndex++) {
      ...
      if (shardIndex === 0) {
        ...
        this.bitsPerSetPointer = bitsPerSetPointer;
        this.bitsPerSetSizeValue = bitsPerSetSizeValue;
        this.bitsPerFixedLengthSetPortion = bitsPerSetPointer + bitsPerSetSizeValue;
